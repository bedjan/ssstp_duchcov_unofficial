...
- [INTELIGENTNÍ DŮM -> DESKY](#inteligentní-dm---desky)
  * [Deska A](#deska-a)
    ...
    + [2) LEGRAND - Bezdrátový spínač](#2-legrand---bezdrátový-spína)
    + [3) LEGRAND - Bezdrátový žaluziový spínač](#3-legrand---bezdrátový-aluziový-spína)
    + [4) Žaluzie signalizace](#4-aluzie-signalizace)
    + [5) LEGRAND - Komunikační brána EMDX3 with Netatmo](#5-legrand---komunikaní-brána-emdx3-with-netatmo)
    + [6) LEGRAND - Připojená mobilní zásuvka](#6-legrand---pipojená-mobilní-zásuvka)
  ...
  * [Deska C](#deska-c)
    + [1) NETATMO - Chytrý detektor kouře](#1-netatmo---chytrý-detektor-koue)
    + [2) NETATMO - Zvonek](#2-netatmo---zvonek)
    + [3) NETATMO - Vnitřní kamera](#3-netatmo---vnitní-kamera)
    + [4) NETATMO - Vnější kamera ](#4-netatmo---vnjí-kamera)
    + [LEGRAND - další návody](#legrand---dalí-návody)
<!-- TOC end -->
